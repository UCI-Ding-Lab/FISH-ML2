...
class abstract():
    ...
    def update_thumbnail(self):
        ...
        self.__img_np_rgb = grayscale_to_rgb(remove_outliers(base_img, k=10.0)) if self.selected_channel == "488" else grayscale_to_rgb(base_img) # rgb is for displaying image while SAM and groundingdino accepts 2D
