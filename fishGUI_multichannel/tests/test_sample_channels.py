...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("MAXEXP250921COLB01_w1-DAPI_s001.tif", "001", "DAPI"),
        ("MAXEXP250921COLB01_w3-AF594_s006.tif", "006", "594"),
...
def test_normalize_channel_name_maps_known_wavelengths_and_keeps_unknowns(channel, expected):
    """Normalize known wavelength labels while preserving unknown channel labels."""
