...
def test_current_channel_mask_property_updates_the_current_channel_storage(bare_abstract_factory):
    abs_obj = bare_abstract_factory()
    abs_obj.current_channel_mask = [3]

    assert abs_obj.current_channel_mask == [3]
